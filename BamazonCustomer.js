                    ...
                    function(err,data) {
                      ...
                      if (data.length === 0) {
                        ...
                        // console.log('productData = ' + JSON.stringify(productData));
                         console.log('productData.stock_quantity = ' + productData.stockQuantity);
                        ...
                        if (quantity <= productData.stockQuantity) {
                          ...
                          var updateQueryStr = 'UPDATE product SET stockQuantity = ' + (productData.stockQuantity - quantity) + ' WHERE item_id = ' + item;
